...
CREATE TABLE IF NOT EXISTS contracts (
    ...
    -- Header. contract_no is generated by the app right after insert
    -- (format AM-YYYY-#### based on the row's own id), so it is briefly
    -- NULL between the INSERT and the follow-up UPDATE — see save.php.
